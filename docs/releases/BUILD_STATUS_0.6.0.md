...
test_event (test_core.Tests.test_event) ... /mnt/data/WireVault_FabOS_Alpha_0.6.0_Production_DesignVault/fabos_core/events/bus.py:6: DeprecationWarning: datetime.datetime.utcnow() is deprecated and scheduled for removal in a future version. Use timezone-aware objects to represent datetimes in UTC: datetime.datetime.now(datetime.UTC).
...
The build was validated in this environment. Final visual and workflow acceptance
still needs to be performed on the user's Windows 7 computer.
