...
(18,"""CREATE TABLE IF NOT EXISTS inventory_transactions(id TEXT PRIMARY KEY,item_type TEXT NOT NULL,item_id TEXT NOT NULL,transaction_type TEXT NOT NULL,quantity REAL NOT NULL,unit TEXT,reference_type TEXT,reference_id TEXT,notes TEXT,created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP);"""),
...
(31,"""INSERT OR IGNORE INTO shop_settings(key,value) VALUES('shop_name','WireVault FabOS'),('shop_owner_name',''),('shop_email',''),('shop_phone',''),('shop_address',''),('invoice_prefix','INV'),('invoice_due_days','14'),('default_tax_percent','0'),('quote_valid_days','14'),('currency_symbol','$'),('backup_retention','30'),('default_slicer','Cura'),('customer_update_signature','');"""),
...
(34,"""CREATE TABLE IF NOT EXISTS notifications(id TEXT PRIMARY KEY,dedupe_key TEXT UNIQUE,severity TEXT NOT NULL DEFAULT 'info',title TEXT NOT NULL,body TEXT,page TEXT,entity_id TEXT,is_read INTEGER NOT NULL DEFAULT 0,created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP,updated_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP);
...
INSERT OR IGNORE INTO shop_settings(key,value) VALUES('auto_backup_on_shutdown','1'),('crash_recovery_enabled','1'),('diagnostic_log_retention_days','30'),('beta_channel','1');"""),
